...
class Setting extends CI_Controller
{
	...
	public function upload_avatar()
	{
		...
		$this->load->view('admin/setting_uploadavatar.php', $data);
	}
	...
	public function edit_profile()
	{
		...
		if ($this->input->method() === 'post') {
			...
			if($this->form_validation->run() === FALSE){
				return $this->load->view('admin/setting_editprofile.php', $data );
			}
		...
		$this->load->view('admin/setting_editprofile.php', $data);
	}
	...
	public function edit_password()
	{
		...
		if ($this->input->method() === 'post') {
			...
			if($this->form_validation->run() === FALSE){
				return $this->load->view('admin/setting_editpassword.php', $data );
			}
		...
		$this->load->view('admin/setting_editpassword.php', $data);
	}
}